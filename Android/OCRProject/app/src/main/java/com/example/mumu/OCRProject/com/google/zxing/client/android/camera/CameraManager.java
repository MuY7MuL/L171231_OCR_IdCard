...
import com.example.mumu.OCRProject.com.google.zxing.client.android.camera.open.OpenCameraManager;
...
public final class CameraManager {
     ...
     */
    public synchronized Rect getFramingRect(String type) {
        int width = 0;
        int height = 0;
        if (framingRect == null) {
            if (camera == null) {
     ...
     * frame, not UI / screen.
     */
    public synchronized Rect getFramingRectInPreview(String type) {
        if (framingRectInPreview == null) {
            Rect framingRect = getFramingRect(type);
            if (framingRect == null) {
                return null;
            }
