...
public final class CaptureActivityHandler extends Handler {
    ...
    //----------按钮点击返回
    public  void quitSynchronouslyBtn(){



        state = State.DONE;
        cameraManager.stopPreview();
        Message quit = Message.obtain(decodeThread.getHandler(), R.id.scan_result_cesi);
        quit.sendToTarget();

       // cameraManager.stopPreview();
//        Message quit = Message.obtain(decodeThread.getHandler(), R.id.return_scan_result);
//        quit.sendToTarget();
//        try {
//            // Wait at most half a second; should be enough time, and onPause() will timeout quickly
//            decodeThread.join(500L);
