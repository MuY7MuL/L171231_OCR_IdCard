...
-(void)addScaningWindow {
    ...
    CGFloat facePathHeight = facePathWidth * 0.712;
    CGRect rect = _IDCardScanningWindowLayer.frame;
    self.facePathRect = (CGRect){CGRectGetMaxX(rect) - facePathWidth*0.85,CGRectGetMaxY(rect) - facePathHeight*1.7,facePathHeight,facePathWidth};
